package it.voltats.gestionepista.test;
...
import static com.calendarfx.view.CalendarView.Page.*;
import static com.calendarfx.view.CalendarView.Page.YEAR;
import static java.util.Objects.requireNonNull;

public class CustomCalendarView extends DateControl {
    ...
    public CustomCalendarView() {
        this(CalendarView.Page.values());
    }

    /**
     * Constructs a new calendar view.
     */
    public CustomCalendarView(CalendarView.Page... availablePages) {
        ...
        getProperties().addListener((MapChangeListener.Change<?, ?> change) -> {
            if (change.getKey().equals(SELECTED_PAGE)) {
                if (change.getValueAdded() != null) {
                    CalendarView.Page page = (CalendarView.Page) change.getValueAdded();
    ...
    protected Skin<?> createDefaultSkin() {
        return new CustomCalendarViewSkin(this);
    }

    public PageBase getPageView(CalendarView.Page page) {
        switch (page) {
            case DAY:
                return getDayPage();
            case WEEK:
    ...
    private final ObservableList<CalendarView.Page> availablePages = FXCollections.observableArrayList();
     ...
     */
    public final ObservableList<CalendarView.Page> getAvailablePages() {
    ...
    private final ReadOnlyObjectWrapper<CalendarView.Page> selectedPage = new ReadOnlyObjectWrapper<>(this, "selectedPage");
     ...
     */
    public final ReadOnlyObjectProperty<CalendarView.Page> selectedPageProperty() {
     ...
     * @return the selected page view
     */
    public final CalendarView.Page getSelectedPage() {
        return selectedPageProperty().get();
    }

    /**
     * Returns the view for the currently selected {@link CalendarView.Page}.
     *
     * @return the selected page view
