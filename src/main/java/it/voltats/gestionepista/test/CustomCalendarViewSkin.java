...
import static it.voltats.gestionepista.test.CustomCalendarView.Page;
...
public class CustomCalendarViewSkin extends SkinBase<CustomCalendarView>{
    ...
    public CustomCalendarViewSkin(CustomCalendarView view) {
        super(view);
        ...
        CustomCalendarViewSkin.TrayPane trayPane = new CustomCalendarViewSkin.TrayPane();
    ...
    private void updateCalendarVisibility() {
        CustomCalendarView view = getSkinnable();
    ...
    private void buildLeftToolBarBox() {
        ...
        if (getSkinnable().isShowPageToolBarControls()) {
            CalendarView.Page page = getSkinnable().getSelectedPage();
